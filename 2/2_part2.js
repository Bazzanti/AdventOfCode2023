{
    ...
    function day2_part2Func(input) {
        ...
        game.forEach(gameData => {
                result += (gameData?.red || 0) * (gameData?.green || 0) * (gameData?.blue || 0);
        });
    ...
    // TEST
    const resultTest = day2_part2Func(test);
    console.log(resultTest); //2286
    
    // REAL INPUT
    var fs = require("fs");
    var text = fs.readFileSync("./input.txt", "utf-8");
    const result = day2_part2Func(text);
    console.log(result);
